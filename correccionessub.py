...
def subfuncion_ronda1(jugador1, jugador2, jugador3, jugador4, jugador5, jugador6, mesa):
    while (jugador1['jugando'] and jugador2['jugando'] and jugador3['jugando'] and jugador4['jugando'] and
           ...
           (jugador1['cantidad apostada'] != mesa['cantidad apostada por cada jugador'] and
            jugador2['cantidad apostada'] != mesa['cantidad apostada por cada jugador'] and
            jugador3['cantidad apostada'] != mesa['cantidad apostada por cada jugador'] and
            jugador4['cantidad apostada'] != mesa['cantidad apostada por cada jugador'] and
            jugador5['cantidad apostada'] != mesa['cantidad apostada por cada jugador'] and
        ...
        if jugador1['cantidad apostada'] != mesa['cantidad apostada por cada jugador']:
            ...
            if decision_segunda == "a":
                ...
                if decision_tercera == "i":
                    ...
                    subida = int(input("¿Cuánto más quieres subir?: "))
            ...
            break
        if jugador1['cantidad apostada']==jugador2['cantidad apostada']and jugador2['cantidad apostada']==jugador3['cantidad apostada']and jugador3['cantidad apostada']== jugador4['cantidad apostada']and jugador4['cantidad apostada']==jugador5['cantidad apostada']and jugador5['cantidad apostada']==jugador6['cantidad apostada']:
            break
...
def subfuncion3_ronda1(jugador1, jugador2, jugador3, jugador4, jugador5, jugador6, mesa):
    while (jugador1['jugando'] and jugador2['jugando'] and jugador3['jugando'] and jugador4['jugando'] and
           ...
           (jugador1['jugando'] and jugador2['jugando'] and jugador3['jugando'] and jugador4['jugando'] and
            jugador5['jugando'] and jugador6['jugando']) and
           (jugador1['cantidad apostada'] != jugador2['cantidad apostada'] and
            jugador2['cantidad apostada'] != jugador3['cantidad apostada'] and
            jugador3['cantidad apostada'] != jugador4['cantidad apostada'] and
            jugador4['cantidad apostada'] != jugador5['cantidad apostada'] and
            jugador5['cantidad apostada'] != jugador6['cantidad apostada'] and
            jugador6['cantidad apostada'] != mesa['cantidad apostada por cada jugador'])):
