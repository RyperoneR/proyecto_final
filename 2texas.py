...
from supercorrec import subfuncion6_ronda1 as sub
import ronda
...
def ronda_1(jugador1, jugador2, jugador3, jugador4, jugador5, jugador6, mesa):
    if jugador1['jugando']:
        # Restablecer las cantidades apostadas
        jugador1['cantidad apostada'] = 0
        jugador2['cantidad apostada'] = 0
        jugador3['cantidad apostada'] = 0
        jugador4['cantidad apostada'] = 0
        jugador5['cantidad apostada'] = 0
        jugador6['cantidad apostada'] = 0
        mesa['cantidad apostada por cada jugador'] = 0

        decision = input("pasar(p)/apostar(a)/irse(i): ")

        if decision == "a":
            cantidad = int(input("¿Cuánto quieres apostar?: "))
            if cantidad <= jugador1['fichas']:
                ...
                sub(jugador1, jugador2, jugador3, jugador4, jugador5, jugador6, mesa)
            else:
                print("No tienes suficientes fichas para esa apuesta. Inténtalo de nuevo.")
                ronda_1(jugador1, jugador2, jugador3, jugador4, jugador5, jugador6, mesa)
            ...
            print("Ha ocurrido un error. Por favor, inténtalo de nuevo.")
            ronda_1(jugador1, jugador2, jugador3, jugador4, jugador5, jugador6, mesa)
...
jugadores = [user,jugador_1,jugador_2,jugador_3,jugador_4,jugador_5]  
